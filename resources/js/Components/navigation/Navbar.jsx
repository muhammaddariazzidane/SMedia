...
import { FaBars, FaUserAstronaut, FaUsers } from "react-icons/fa";
...
export default function Navbar({ auth }) {
    ...
    return (
        <nav className="navbar px-4 py-3 lg:px-6 dark:bg-gray-800 bg-white shadow-gray-200 dark:shadow-gray-600 shadow">
            <div className="navbar-start">
                ...
                <div
                    className={`lg:flex bg-white dark:bg-gray-800 md:flex sm:flex items-center  xl:flex ${
                        menu
            ...
            <div className="navbar-center">
                <Link
                    href={route("home")}
                    className="btn btn-ghost normal-case text-2xl group "
                >
            ...
            <div className="navbar-end">
                {auth.user ? (
                    <div className="dropdown dropdown-end">
                        ...
                        <ul
                            tabIndex={0}
                            className="mt-3 z-[1] gap-1 p-2 px-1 shadow-md menu menu-sm dropdown-content text-gray-800 dark:text-white bg-white dark:bg-gray-800 rounded-md w-36"
                        >
                            <li className="mb-1">
                                <Link href={route("profile.edit")}>
                                    <FaUserAstronaut className="w-5 h-5 text-gray-800 dark:text-gray-300" />
